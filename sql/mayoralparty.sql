...
ALTER TABLE IF EXISTS ONLY public.mayoral_party DROP CONSTRAINT IF EXISTS mayoral_party_pkey;
DROP TABLE IF EXISTS public.mayoral_party;
...
--
-- Name: mayoral_party; Type: TABLE; Schema: public; Tablespace:
--

CREATE TABLE mayoral_party (
    geo_level character varying(15) NOT NULL,
    geo_code character varying(10) NOT NULL,
    "mayoral party" character varying(128) NOT NULL,
    total integer NOT NULL
);


--
-- Data for Name: mayoral_party; Type: TABLE DATA; Schema: public
--

COPY mayoral_party (geo_level, geo_code, "mayoral party", total) FROM stdin WITH DELIMITER ',';
country,NP,CPN-UML,294
country,NP,Maoist Kendra,106
country,NP,Nepali Congress,266
country,NP,Others,82
country,NP,Rastriya Prajatantra Party,5
district,68,CPN-UML,3
district,68,Nepali Congress,5
district,68,Maoist Kendra,2
district,68,Rastriya Prajatantra Party,0
district,68,Others,0
district,46,CPN-UML,1
district,46,Nepali Congress,4
district,46,Maoist Kendra,1
district,46,Rastriya Prajatantra Party,0
district,46,Others,0
district,51,CPN-UML,4
district,51,Nepali Congress,4
district,51,Maoist Kendra,1
district,51,Rastriya Prajatantra Party,0
district,51,Others,1
district,73,CPN-UML,3
district,73,Nepali Congress,6
district,73,Maoist Kendra,1
district,73,Rastriya Prajatantra Party,0
district,73,Others,0
district,69,CPN-UML,8
district,69,Nepali Congress,4
district,69,Maoist Kendra,0
district,69,Rastriya Prajatantra Party,0
district,69,Others,0
district,67,CPN-UML,3
district,67,Nepali Congress,6
district,67,Maoist Kendra,0
district,67,Rastriya Prajatantra Party,0
district,67,Others,0
district,65,CPN-UML,4
district,65,Nepali Congress,2
district,65,Maoist Kendra,0
district,65,Rastriya Prajatantra Party,1
district,65,Others,1
district,32,CPN-UML,2
district,32,Nepali Congress,6
district,32,Maoist Kendra,0
district,32,Rastriya Prajatantra Party,0
district,32,Others,8
district,66,CPN-UML,3
district,66,Nepali Congress,2
district,66,Maoist Kendra,3
district,66,Rastriya Prajatantra Party,0
district,66,Others,0
district,25,CPN-UML,3
district,25,Nepali Congress,0
district,25,Maoist Kendra,0
district,25,Rastriya Prajatantra Party,0
district,25,Others,1
district,06,CPN-UML,4
district,06,Nepali Congress,4
district,06,Maoist Kendra,1
district,06,Rastriya Prajatantra Party,0
district,06,Others,0
district,35,CPN-UML,4
district,35,Nepali Congress,1
district,35,Maoist Kendra,2
district,35,Rastriya Prajatantra Party,0
district,35,Others,0
district,74,CPN-UML,2
district,74,Nepali Congress,4
...
district,13,CPN-UML,5
district,13,Nepali Congress,4
district,13,Maoist Kendra,1
...
district,12,Nepali Congress,4
district,12,Maoist Kendra,1
district,12,Rastriya Prajatantra Party,0
district,12,Others,0
district,43,CPN-UML,6
district,43,Nepali Congress,4
district,43,Maoist Kendra,0
district,43,Rastriya Prajatantra Party,0
district,43,Others,0
district,02,CPN-UML,3
district,02,Nepali Congress,4
district,02,Maoist Kendra,1
...
district,33,CPN-UML,2
district,33,Nepali Congress,3
district,33,Maoist Kendra,3
...
district,01,Nepali Congress,4
district,01,Maoist Kendra,0
district,01,Rastriya Prajatantra Party,0
district,01,Others,0
district,08,CPN-UML,5
district,08,Nepali Congress,1
district,08,Maoist Kendra,0
district,08,Rastriya Prajatantra Party,0
district,08,Others,0
district,14,CPN-UML,6
district,14,Nepali Congress,1
district,14,Maoist Kendra,1
...
--
-- Name: mayoral_party_pkey; Type: CONSTRAINT; Schema: public; Tablespace:
--

ALTER TABLE ONLY mayoral_party
    ADD CONSTRAINT mayoral_party_pkey PRIMARY KEY (geo_level, geo_code, "mayoral party");
